...
win.title("DIT AI HAND GESTURE DRONE") # 제목 표시줄 추가
win.geometry("640x530") # 지오메트리: 너비x높이+x좌표+y좌표
win.resizable(width=0, height=0) # x축, y축 크기 조정 비활성화
...
# label0.place(x=50, y=590, width=165, height=50)
# label1 = tk.Label(win, text='battery: {}'.format(tello.get_battery()), fg='white', bg='black', font='Helvetica 11')
# label1.place(x=0, y=590, width=165, height=50)      # 현재 배터리 백분율 가져오기
# label2 = tk.Label(win, text='temper: {}'.format(tello.get_temperature()), fg='white', bg='black', font='Helvetica 11')
# label2.place(x=150, y=590, width=165, height=50)    # 평균 온도 얻기
# label3 = tk.Label(win, text="height: {}".format(tello.get_height()), fg='white', bg='black', font='Helvetica 11')
# label3.place(x=300, y=590, width=165, height=50)    # 현재 높이를 cm 단위로 가져오기
# label4 = tk.Label(win, text="tof distance: {}".format(tello.get_distance_tof()), fg='white', bg='black', font='Helvetica 11')
# label4.place(x=450, y=590, width=165, height=50)    # 현재 거리 값(cm) 가져오기



label2 = tk.Label(win, text="battery: 50%", fg='white', bg='black')
label2.place(x=0, y=480, width=165, height=50)
label3 = tk.Label(win, text="temper: 20°", fg='white', bg='black')
label3.place(x=160, y=480, width=165, height=50)
label4 = tk.Label(win, text="height: 0cm", fg='white', bg='black')
label4.place(x=320, y=480, width=165, height=50)
label5 = tk.Label(win, text="tof distance: 0cm", fg='white', bg='black')
label5.place(x=480, y=480, width=165, height=50)
